...
def process_block(env_name, printing_mode):
    ...
    coordinates, init_adjacency_matrix, edges, G, max_edge_length, boundary_nodes_array, faces = env_o.build_graph(interval, material)
    ...
    if len(global_beam_seq) == 0:
        ...
        if calc_mode == 'Euler':
            if material == 'CCF':
                ...
                if base_exists and cross_exists:
                    ...
                    func.final_progress()
                    print('Generate CCF tool path in outputs folder')
                else:
                    folder_path = "outputs"
                    if not os.path.exists(folder_path):
                        os.makedirs(folder_path)
                    ...
                    func.final_progress()
                    print('Generate CCF toolpath in outputs folder')
            ...
            if material == 'PLA3D':
                ...
                with open(output_path, 'w') as f:
                    ...
                    for coord in coordinates_path:
                        ...
                        if normal is not None:
                            ...
                            # print(f"{best_path[ii - 1]} to {best_path[ii]} node")
                ...
                func.final_progress()
                print('Generate wireframe toolpath in outputs folder')
        ...
        if calc_mode == 'Tsp':
            ...
            func.final_progress()
            print('Generate metal toolpath in outputs folder')
